...
| <a name="input_tags"></a> [tags](#input\_tags) | n/a | <pre>object({<br>    project : string,<br>    service : string,<br>    env : string,<br>    owner : string,<br>    managedBy : string,<br>  })</pre> | n/a | yes |
