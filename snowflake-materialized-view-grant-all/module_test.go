...
const vars string = "{\"database_name\":\"database\",\"materialized_view_name\":\"materialized_view\",\"roles\":[\"role_a\",\"role_b\",\"role_c\"],\"schema_name\":\"schema\",\"shares\":[\"share_a\",\"share_b\",\"share_c\"]}"
const onFutureVars string = "{\"database_name\":\"database\",\"materialized_view_name\":\"materialized_view\",\"on_future\":true,\"roles\":[\"role_a\",\"role_b\",\"role_c\"],\"schema_name\":\"schema\"}"
