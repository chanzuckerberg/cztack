...
const onFutureVars string = "{\"arguments\":[{\"name\":\"foo\",\"type\":\"STRING\"}],\"database_name\":\"database\",\"function_name\":\"function\",\"on_future\":true,\"roles\":[\"role_a\",\"role_b\",\"role_c\"],\"schema_name\":\"schema\"}"
